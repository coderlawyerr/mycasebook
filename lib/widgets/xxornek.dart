...
//       String url2 = await snapshot.ref.getDownloadURL();
//       // String url2 = await(await yuklemeGorevi.onComplete).ref.getDownloadUrl();
//       setState(() {
//         indirmeBaglantisi = url2;
//       });
//     });
//   }
...
//                                       product,
//                                       File("ürünlerim")) //yolu nasıl vereceg
